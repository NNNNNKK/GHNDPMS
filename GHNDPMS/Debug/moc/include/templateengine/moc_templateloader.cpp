...
#include "../../../../include/templateengine/templateloader.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TemplateLoader_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TemplateLoader_t qt_meta_stringdata_TemplateLoader = {
    {
QT_MOC_LITERAL(0, 0, 14) // "TemplateLoader"
...
QT_INIT_METAOBJECT const QMetaObject TemplateLoader::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_TemplateLoader.data,
    qt_meta_data_TemplateLoader,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TemplateLoader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TemplateLoader.stringdata0))
